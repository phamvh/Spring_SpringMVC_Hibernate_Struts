...
public class UserDetails {
	...
	/**
	 * This hibernate own's annotation tells  hibernate that this is a primary key for the foreign table USER_ADDRESS
	 * hilo is a common type of generator that hibernate provides.
	 * This first assign the name "hilo-gen" to the generator to be used later, 
	 * and then defines the name of the column to be used as PK; PK is generated using hilo-gen, and the type of PK is long.
	 */
